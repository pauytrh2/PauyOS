...
void __attribute__((cdecl)) i686_ISR_Handler(Registers* regs)
{
    ...
    else 
    {
        ...
        decoration();
        printf("The kernel is now in panic (aka 'KERNEL PANIC!').\n");
        printf("There is nothing you can do, so sit back, grub a cup of coffee and watch as your operating system is hanging and is no longer bootable. Enjoy!\n");
        decoration();
